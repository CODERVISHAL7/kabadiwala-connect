  ...
  return (
    ...
    >
      ...
      <Text style={styles.subtitle}>
        Your accepted offers and marketplace transactions
      </Text>
  ...
  <View style={styles.handoverBox}>
    ...
    {handoverTransactionId !== transaction.id ? (
      <Pressable
        ...
        onPress={() => {
          setHandoverTransactionId(transaction.id);

          setFinalWeight(
            transaction.material_lots?.approx_weight?.toString() || ''
          );

          setFinalPrice(
            transaction.quoted_price?.toString() || ''
          );
        }}
      >
      ...
      <Pressable
        style={[
          ...
          processingHandover && styles.disabledButton,
        ]}
